...
@app.put('/blog/{id}', response_model=schemas.ShowBlog, status_code=status.HTTP_202_ACCEPTED, tags=['blogs'])
...
@app.post('/user', response_model=schemas.UserView, tags=['User'])
...
@app.get('/user/{id}', response_model=schemas.UserView, tags=['User'] )
